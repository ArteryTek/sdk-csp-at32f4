...
#include "board.h"
    ...
    defined (BSP_USING_PWM5)  || defined (BSP_USING_PWM6)  || \
    defined (BSP_USING_PWM7)  || defined (BSP_USING_PWM8)  || \
    defined (BSP_USING_PWM9)  || defined (BSP_USING_PWM10) || \
    defined (BSP_USING_PWM11) || defined (BSP_USING_PWM12) || \
    defined (BSP_USING_PWM13)
#include "drv_pwm.h"
