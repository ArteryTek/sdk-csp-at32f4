...
#if defined (BSP_USING_HWTMR1)  || defined (BSP_USING_HWTMR2)  || \
    defined (BSP_USING_HWTMR3)  || defined (BSP_USING_HWTMR4)  || \
    defined (BSP_USING_HWTMR5)  || defined (BSP_USING_HWTMR6)  || \
    defined (BSP_USING_HWTMR7)  || defined (BSP_USING_HWTMR8)  || \
    defined (BSP_USING_HWTMR9)  || defined (BSP_USING_HWTMR10) || \
    defined (BSP_USING_HWTMR11) || defined (BSP_USING_HWTMR12) || \
    defined (BSP_USING_HWTMR13) || defined (BSP_USING_HWTMR14)
