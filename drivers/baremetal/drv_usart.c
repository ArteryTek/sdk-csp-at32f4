...
static long at32_uart_clk_enable(struct at32_uart_config *config)
{
    /* uart clock enable */
...
static long at32_gpio_configure(struct at32_uart_config *config)
{
...
static long at32_configure(struct at32_uart_config *config)
{
...
void print_char(char c)
{
    ...
    USART_SendData(_uart_config->Instance, c);
}
